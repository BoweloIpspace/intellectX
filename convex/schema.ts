...
export default defineSchema({
  ...
  courses: defineTable({
    ...
    curriculumOrInstitution: v.optional(v.string()),
    gradeOrYear: v.optional(v.string()),
    duration: v.string(),
    accent: v.string(),
  ...
  pastPaperQuestions: defineTable({
    ...
    stimulusSourceStatus: v.optional(v.union(v.literal("source-text"), v.literal("reconstructed-visual"))),
