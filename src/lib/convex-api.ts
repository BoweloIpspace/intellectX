...
export const convexApi = {
  ...
  quizzes: {
    ...
    checkLocalQuizAnswer: makeFunctionReference<"query">("quizzes:checkLocalQuizAnswer"),
    revealLocalStructuredQuizAnswer: makeFunctionReference<"query">("quizzes:revealLocalStructuredQuizAnswer"),
    submitLocalQuizAttempt: makeFunctionReference<"query">("quizzes:submitLocalQuizAttempt"),
