...
export const premiumAccessProductKey = "intellectx.scholar";
...
export function getContentAccessLevel(value: { accessLevel?: ContentAccessLevel } | null | undefined) {
  return value?.accessLevel ?? "free";
}
