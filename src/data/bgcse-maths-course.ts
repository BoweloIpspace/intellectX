...
export const bgcseMathsCourse: Course = {
  ...
  description:
    "BGCSE Mathematics practice. Topics 1 and 2 cover core number skills plus approximation, accuracy, bounds and units with six exam-style quizzes.",
  subject: "Mathematics",
  level: "Beginner",
  duration: "6 quizzes",
  progress: 0,
  lessonIds: [BGCSE_MATHS_TOPIC_1_ID, BGCSE_MATHS_TOPIC_2_ID],
  quizIds: [
    "bgcse-maths-t01-q1",
    "bgcse-maths-t01-q2",
    "bgcse-maths-t01-q3",
