...
export function LegalPage({ title, description, sections, effectiveDate = "June 28, 2026" }: LegalPageProps) {
  return (
    <main className="relative mx-auto w-full max-w-3xl py-12">
      ...
      <article className={`rounded-lg p-6 leading-7 md:p-8 ${elevatedGlassCardClassName}`}>
        <p className="text-muted-foreground mb-8 text-sm">Effective date: {effectiveDate}</p>
